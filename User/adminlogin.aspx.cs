...
public partial class User_adminlogin : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        cmd.CommandText="Select * from admin where admin_id="+txtadmin_id.Text+"and apassword='"+txtapassword.Text+"'and aname='"+txtaname.Text+"'";
        cmd.Connection=cn;
        cmd.ExecuteNonQuery();
