<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.master" AutoEventWireup="true" CodeFile="job by category.aspx.cs" Inherits="User_job_by_category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" cellpadding="8" cellspacing="5" style="border:thin solid #C0C0C0" width="90%">
        <tr>
            <td style="text-align: center" class="style146" align="left">
                S<strong>elect Job Category</strong></td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td align="left" valign="top" >
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT DISTINCT [job_category] FROM [jobdetails]"></asp:SqlDataSource>
            </td>
            <td valign="top">
            <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" 
                BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                CellSpacing="2" DataSourceID="SqlDataSource3" GridLines="Both" 
                    onselectedindexchanged="DataList1_SelectedIndexChanged" Width="800px" 
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="btnapply" runat="server" BackColor="Maroon" ForeColor="White" 
                                    style="font-weight: 700; background-color: #CC0000;" 
