<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.master" AutoEventWireup="true" CodeFile="job by location.aspx.cs" Inherits="User_job_by_location" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" cellpadding="8" cellspacing="5" 
        style="border: thin solid #C0C0C0" width="90%">
        <tr>
            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="btnapply" runat="server" BackColor="Maroon" ForeColor="White" 
                                    ...
                                    style="text-align: center; font-weight: 700; font-family: Arial, Helvetica, sans-serif; color: #FFFFFF; background-color: #CC0000;" 
